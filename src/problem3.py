...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (40, 40), 4 lines'
    window3 = rg.RoseWindow(450, 300, title)
...
def problem3a(window, point, n):
    ...
    # -------------------------------------------------------------------------
    final_point = rg.Point(point.x, point.y + 50)
    thickness = 1
    sum = 0

    for _ in range(n):
        line = rg.Line(point, final_point)
        line.attach_to(window)

        line.thickness = thickness
        point.x = point.x + 20
        point.y = point.y + 10
        final_point.x = final_point.x + 20
        final_point.y = final_point.y + 10
        window.render()
...
def problem3b(m, point1):
    ...
    for k in range(m):
        point_iteration = rg.Point(x, y)
        summ = summ + problem3a(window, point_iteration, 3 + (2 * k))
        y = y + 60
